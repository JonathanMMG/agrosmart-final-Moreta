...
- **Nombre completo:** Moreta Jonathan
- **Cédula:** 1724530751
- **NRC:** 30405
- **Nonce del examen:** AGS-2026
- **Fecha y hora de inicio:** 2026-07-30 19:38
...
|:---:|-----------|-----------------|----------|
| — | `NN` | los 2 últimos dígitos de mi cédula | 51 |
| 1 | Nombre de la tabla | `tbl_productos_base_` + `NN` | tbl_productos_base_51 |
| 2 | Puerto | `81` + `NN` | 8151 |
...
- **Enlace al video (5 min, cámara + pantalla):** https://youtu.be/YaGJtbCbprs
...
**Firma (nombre completo):** Jonathan Moreta
